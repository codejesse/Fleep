      ...
      <footer class="bg-[#252525] p-7">
        <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
            ...
            <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                ...
                <ul class="text-white font-normal">
                  ...
                  <li>
                    <a href="https://tailwindcss.com/" class="hover:underline">Highlights</a>
                  </li>
                  <li className='mt-4'>
                    <a href="https://tailwindcss.com/" class="hover:underline">Documents</a>
                  </li>
                </ul>
              </div>
              <div>
          ...
          <div class="sm:flex sm:items-center sm:justify-between">
            <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://flowbite.com/" class="hover:underline">FLEEP™</a>. All Rights Reserved.
            </span>
